...
- Concrete types hidden under `internal/query/internal/`.
...
### 2. Data Layer
- Create `internal/query/internal/data/adapter.go`:
...
### 3. Index Layer
- Create `internal/query/internal/index/`:
...
### 4. Query Execution
- Update `internal/query/internal/engine/engine.go`:
