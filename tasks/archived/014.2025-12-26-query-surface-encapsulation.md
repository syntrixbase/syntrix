...
- Multi-database checks: ensure database is required on public entrypoints (with temporary `DefaultDatabase` for dev), index/rebuild/checkpoint partitioning per database, and watch/replication routing stays database-scoped.
