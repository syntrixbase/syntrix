...
- `subscriptionInfo` struct stores database, collection, filters for each subscription
...
```go
func (rs *remoteStream) Subscribe(database, collection string, filters []Filter) (string, error) {
    // ... existing logic ...
