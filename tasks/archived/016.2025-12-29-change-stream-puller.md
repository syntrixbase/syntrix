...
- Puller uses shorter JSON keys: `database` (not `databaseId`), `documentId` (not `id`)
...
- Use database-level watch (not per-database) - see [Design Details Section 3](../docs/design/server/puller/002.design-details.md)
