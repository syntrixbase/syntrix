...
Depends On: [014.query-surface-encapsulation](014.2025-12-26-query-surface-encapsulation.md), [016.change-stream-puller](016.2025-12-29-change-stream-puller.md)
...
- Expand `WatchCollection` signature:
  ```go
  Watch(ctx, database, collection string, filters Filters, startAfter string) (<-chan Event, error)
  ```
...
- Multi-database: per-database index partitioning, isolation.
