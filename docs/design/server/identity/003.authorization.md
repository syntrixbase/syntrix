    ...
    match:
      ...
      /rooms/{roomId}:
        ...
        match:
          /messages/{messageId}:
            allow:
              read: "request.auth.uid in get('/databases/' + database + '/documents/rooms/' + roomId).data.members"
              create: "request.auth.uid in get('/databases/' + database + '/documents/rooms/' + roomId).data.members"
