...
| `database` | string | Database ID (NOT "databaseId") |
...
func (c *IndexEventConsumer) handleIndexUpdate(ctx context.Context, evt *pullerv1.PullerEvent) error {
