...
const file_puller_proto_rawDesc = "" +
	...
	"\rPullerService\x12R\n" +
	"\tSubscribe\x12#.syntrix.puller.v1.SubscribeRequest\x1a\x1e.syntrix.puller.v1.PullerEvent0\x01B7Z5github.com/syntrixbase/syntrix/api/puller/v1;pullerv1b\x06proto3"
